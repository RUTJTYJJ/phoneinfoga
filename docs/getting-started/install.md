To install PhoneInfoga, you'll need to download the binary or build the software from its source code.11a239c4be919463dd0a474ef03ca00b7e11720e27a8edfb495e947fd0a69efa  phoneinfoga_Linux_arm64.tar.gz
